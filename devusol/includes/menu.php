<div id="navborder">
  ...
  <div class="dropdown large-dropdown">
    ...
    <ul class="col-md-offset-2 col-md-10 dropdown-menu solutions-menu">
      ...
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/PBBT_011.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="pbbt-20200.php">20200</a>
        <p class="subtext d-none">sub-text 2</p>
      </li>
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/BM3010_PP0001.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="pbbt-3010.php">3010</a>
        <p class="subtext d-none">sub-text 3</p>
      </li>
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/PBBT_011.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="play-detector.php">PLAY DETECTOR</a>
        <p class="subtext d-none">sub-text 4</p>
      </li>
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/BM3010_PP0001.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="lease-audit.php">LEASE/AUDIT</a>
