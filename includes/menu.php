    ...
    <div class="collapse navbar-collapse" id="navmenu">
          ...
          <ul class="navbar-nav nav-fill mr-auto w-100">
            ...
            <li class="nav-item dropdown">
              <a id="solutions-dropdown" img-src="images/BM3010_PP0001.jpg" href="#" class="nav-link dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">PBBT SOLUTIONS</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="#">AIR SYSTEM EXPERT</a>
            </li>
  ...
  <div class="dropdown large-dropdown">
    ...
    <ul class="col-md-offset-2 col-md-10 dropdown-menu solutions-menu">
      ...
      <li style="margin-top: 15px" class="dropdown ">
        <hr class="line" />
        <a img-src="images/BM3010_PP0001.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="#">14200</a>
      </li>

      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/PBBT_011.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="#">20200</a>
      </li>
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/BM3010_PP0001.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="#">3010</a>
      </li>
      <li class="dropdown">
        <hr class="line" />
    ...
    <ul class="col-md-offset-2 col-md-10 dropdown-menu served-menu">
      ...
      <li style="margin-top: 15px" class="dropdown">
        <hr class="line" />
        <a img-src="images/PBBT_011.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="#">Enforcement/Roadside</a>
      </li>
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/BM3010_PP0001.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="#">Fleet/Transit</a>
      </li>
      <li class="dropdown">
        <hr class="line" />
        <a img-src="images/PBBT_011.jpg" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" href="#">End-Of-Line</a>
      </li>
