...
window.onload = function (e) {
    ...
    $('nav .dropdown-toggle').mouseenter(function () {
        ...
        $(this).siblings().removeClass("toggled-dropdown-open");
    });
    ...
    $('.nav-item:not(.dropdown)').each((function () {
        ...
        $(this).mouseenter((function () {
            ...
            $('.toggled-dropdown').each((function () {
                $(this).addClass("d-none");
                $(".navbar").css("padding-bottom", "0px");
            }))
        }))
...
$(document).mouseup(e => {
    if (!$('.large-dropdown').is(e.target) // if the target of the click isn't the container...
        &&
        $('.large-dropdown').has(e.target).length === 0) // ... nor a descendant of the container
    {
        console.log("im here");
