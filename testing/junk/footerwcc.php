...
<div class="rightCenter767"><img src="../images/head-foot/link-foot.png" class="img-fluid" alt="Link Engineering logo"></div>
	  ...
	  <div class="text-center"><p class="noteWht">Copyright &copy; <script>document.write(new Date().getFullYear())</script> Link Engineering Company. <br>All Rights Reserved.</p>
	</div>
