...
<?php include 'includes/includes1022.php'; ?>          
  <style>
...
<div id="section2">
    ...
    <div class="smallCol under767">
        <div class="text-center"><img src="images/pics/intropic.jpg" class="img-fluid paddingRight40" alt=""></div>
    </div>
...
<div class="container-fluid" id="section4">	 
   <div class="container" id="section4Content">   
    ...
    <div class="twoCol">
        <h2 class="font42">Fleetnostic</h2>
         </div></div></div>
